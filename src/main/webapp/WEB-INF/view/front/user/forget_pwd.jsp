...
<body>
	...
	<main>
	<div class="container">
		<form class="ma" action="front/user/forgetpwd.do" method="post">
			...
			<div class="form_body">
				<input type="email" placeholder="请输入登录邮箱" name="email" id="email" value="${user.email }">
				<input type="text" placeholder="请输入验证码" name="captcha" value="${user.captcha }">
				<input
					type="button" value="发邮件获取验证码" onclick="submitEmail();">
